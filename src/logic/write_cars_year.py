...
file_path_posts = r"hugo\Sites\carrenting\content\posts\year.md"
file_path_content = r"hugo\Sites\carrenting\content\year.md"

def write_cars_year_posts(md_cars_classics):
    f = open("hugo\Sites\carrenting\content\posts\year.md", "w")
    f.write("Aqui estan los coches anteriores al 2017" + "<!--more-->" + md_cars_classics)
    f.close()
